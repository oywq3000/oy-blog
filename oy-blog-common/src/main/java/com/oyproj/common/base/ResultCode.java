...
public enum ResultCode implements Serializable {
    ...
    USERNAME_DUPLICATE(405,"用户名重复","erorr.username_duplicate"),
    TOKEN_EXPIRE(406,"令牌过期","erorr.token_expire"),
    REFRESH_TOKEN_EXPIRE(406,"令牌过期","erorr.token_expire"),
    INTERNAL_SERVER_ERROR(500, "服务器内部错误", "error.internal"),
    BAD_REQUEST(400, "请求参数错误", "error.bad_request"),
    UNSUPPORTED_USERTYPE(407,"不支持这种角色类型","error.unsupportedUserTypeException"),
