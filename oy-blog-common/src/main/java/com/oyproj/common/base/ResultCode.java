...
public enum ResultCode implements Serializable {
    ...
    USERNAME_DUPLICATE(405,"用户名重复","user.username.duplicate"),
    TOKEN_EXPIRE(406,"令牌过期","token.expired"),
    REFRESH_TOKEN_EXPIRE(406,"令牌过期","token.refresh.expired"),
    INTERNAL_SERVER_ERROR(500, "服务器内部错误", "error.internal"),
    BAD_REQUEST(400, "请求参数错误", "error.bad_request"),
    UNSUPPORTED_USERTYPE(407,"不支持这种角色类型","error.unsupported_user_type"),
